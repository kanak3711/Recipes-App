...
function RenderLeader ({dish}) {
    return (
        ...
        <p class="mb-0" class="text-left">{dish.description}</p>
        </div>
        </div>
...
function About(props) {
    ...
    const leaders = props.leaders.map((leader) => {
        return (
            <div className="m-5"  key={leader.id}>
                <RenderLeader dish={leader}  />
            </div>
    ...
    return(
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col-12">
                    <h2 class="text-left">Corporate Leadership</h2>
                </div>
                <div className="col-12">
                    <Media list>
                        {leaders}
